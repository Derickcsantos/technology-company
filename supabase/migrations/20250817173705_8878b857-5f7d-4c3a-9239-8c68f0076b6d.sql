-- RPCs seguras para criação e analytics + políticas de Storage
...
-- Políticas de Storage para upload público restrito aos buckets corretos
...
create policy if not exists "Anyone can upload to product-images"
on storage.objects for insert
with check (bucket_id = 'product-images');

create policy if not exists "Anyone can upload to blog-images"
on storage.objects for insert
